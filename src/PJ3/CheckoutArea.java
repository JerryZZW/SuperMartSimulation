...
//comparator used in PriorityQueue
...
class CheckoutArea {
  ...
  {
	// add statements
      busyCashierQ = new PriorityQueue <Cashier>();
  ...
  public boolean isCustomerQTooLong()
  {
	...
	// Add statetments
	return (customerQLimit < sizeCustomerQ());
  }
